...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="提交代码" tabindex="-1"><a class="header-anchor" href="#提交代码" aria-hidden="true">#</a> 提交代码</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git add .
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="异常处理" tabindex="-1"><a class="header-anchor" href="#异常处理" aria-hidden="true">#</a> 异常处理</h3><h4 id="您尚未结束您的合并-存在-merge-head-。-请在合并前先提交您的修改。" tabindex="-1"><a class="header-anchor" href="#您尚未结束您的合并-存在-merge-head-。-请在合并前先提交您的修改。" aria-hidden="true">#</a> 您尚未结束您的合并（存在 MERGE_HEAD）。 请在合并前先提交您的修改。</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git merge --abort
git reset --merge
git merge
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="git-cherry-pick-error-commit-commitid-is-a-merge-but-no-m-option-w" tabindex="-1"><a class="header-anchor" href="#git-cherry-pick-error-commit-commitid-is-a-merge-but-no-m-option-w" aria-hidden="true">#</a> git cherry-pick error: commit \${commitID} is a merge but no -m option w</h4><p>error: commit 41ca46337d8e2be420f5604118c1cd3ea0e88213 is a merge but no -m option was given.<br> fatal: cherry-pick failed</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>- A - B - E - F -   master
   \\     /
    C - D           fix
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git cherry-pick \${commitId} -m 2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>显然，E 是一个 merge commit。如果你现在要在其他地方 git cherry-pick E，那么就会有歧义，因为 E 既可以是来自 master branch B - E 的改动 (diff)，也可以是来自 fix branch D - E 的</p><p>按照这个例子，fix 是被 merge 到 master 的。因此，你 git cherry-pick E -m 1 意思就是使用 B - E 的改动，如果是 git cherry-pick E -m 2 意思就是使用 D - E 的改动</p><p>记住一点就好，1 是 “主干”，确切点儿说是被 merge 了代码的 branch，2 是 merge 来源</p><h3 id="版本之间的穿梭回退" tabindex="-1"><a class="header-anchor" href="#版本之间的穿梭回退" aria-hidden="true">#</a> 版本之间的穿梭回退</h3><p>命令方式：</p><ol><li>输入git log 查看所有提交的版本<br> 注意：黄色字体中 commit后面的一串码就是每一个版本号对应的码</li><li>回退到指定版本<br> == 注意：--hard 删除工作空间改动代码，撤销commit，撤销git add . ==</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git reset --hard [提交号]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,74),s=[t];function r(l,c){return i(),n("div",null,s)}const u=e(d,[["render",r],["__file","gitOrder.html.vue"]]);export{u as default};
