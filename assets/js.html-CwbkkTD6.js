import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as t,c as n,g as i}from"./app-nMNP6VoU.js";const a={},r=i(`<h1 id="js" tabindex="-1"><a class="header-anchor" href="#js"><span>js</span></a></h1><h2 id="数组" tabindex="-1"><a class="header-anchor" href="#数组"><span>数组</span></a></h2><h3 id="数组变树" tabindex="-1"><a class="header-anchor" href="#数组变树"><span>数组变树</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>toTree (data) {
  // 空数组
  const result = []
