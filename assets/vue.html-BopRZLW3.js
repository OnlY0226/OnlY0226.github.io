import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as i,g as t}from"./app-DqOJUhVI.js";const s={},a=t(`<h1 id="vue3" tabindex="-1"><a class="header-anchor" href="#vue3"><span>Vue3</span></a></h1><h2 id="挂载全局属性和方法" tabindex="-1"><a class="header-anchor" href="#挂载全局属性和方法"><span>挂载全局属性和方法</span></a></h2><h3 id="app-config-globalproperties" tabindex="-1"><a class="header-anchor" href="#app-config-globalproperties"><span>app.config.globalProperties</span></a></h3><p>在main.js中引入全局要使用的方法，通过app.config.globalProperties添加到全局中。例：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>// main.js
